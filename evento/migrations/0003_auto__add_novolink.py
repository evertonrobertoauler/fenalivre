...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NovoLink'
        db.create_table(u'evento_novolink', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
            ('new_tab', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'evento', ['NovoLink'])


    def backwards(self, orm):
        # Deleting model 'NovoLink'
        db.delete_table(u'evento_novolink')
    ...
    models = {
        ...
        u'evento.novolink': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'NovoLink', '_ormbases': [u'pages.Page']},
